...
class NonMesinRusak extends StatefulWidget {
  final ToolsModel data;
  final BuildContext context;
  const NonMesinRusak({Key? key, required this.context, required this.data})
      : super(key: key);

  @override
  State<NonMesinRusak> createState() =>
      _NonMesinRusakState(context: context, data: this.data);
}

class _NonMesinRusakState extends State<NonMesinRusak> {
  _NonMesinRusakState({required this.context, required this.data});
