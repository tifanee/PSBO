...
class MesinRusak extends StatefulWidget {
  final ToolsModel data;
  final BuildContext context;
  const MesinRusak({Key? key, required this.context, required this.data})
      : super(key: key);

  @override
  State<MesinRusak> createState() =>
      _MesinRusakState(context: context, data: this.data);
}

class _MesinRusakState extends State<MesinRusak> {
  _MesinRusakState({required this.context, required this.data});
